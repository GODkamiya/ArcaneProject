...
public class PieceTypeExtension
{
    private static readonly Dictionary<PieceType, PieceInformation> _pieceInfo = new Dictionary<PieceType, PieceInformation>(){
        ...
        {PieceType.Emperor, new PieceInformation("皇帝", "", "") },
        ...
        {PieceType.Hermit, new PieceInformation("隠者", "このコマは召喚されてから2ターン、透明状態になる。その後、1ターンだけ透明状態が解除される。このサイクルを繰り返し続ける。", "味方のコマ1体を、次の相手のターンの終わりまで透明状態にする。") },
